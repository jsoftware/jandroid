...
{
  String f=ConfigPath.filePath("style.cfg");
...
String Style::read()
{
  String r=String::number(color.red()) + " "
           + String::number(color.green()) + " "
           + String::number(color.blue());
...
// ---------------------------------------------------------------------
void Style::set(String s)
{
  String[] p=s.toLower().split(" ");     // SkipEmptyParts

import com.jsortware.jn.base.androidextras;
...
void android_exec_host(char* action, char* uri, char* mime, int flag)
{
  ...
  QAndroidJniObject intent("android/content/Intent", "(Ljava/lang/String;)V", QAndroidJniObject::fromString(String::fromUtf8(action)).object<jString>());
  ...
  if (uri && strlen(uri)) {
    QAndroidJniObject objuri = QAndroidJniObject::callStaticObjectMethod("android/net/Uri", "parse", "(Ljava/lang/String;)Landroid/net/Uri;", QAndroidJniObject::fromString(String::fromUtf8(uri)).object<jString>());
    if (mime && strlen(mime))
      intent.callObjectMethod("setDataAndType", "(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;", objuri.object<jobject>(), QAndroidJniObject::fromString(String::fromUtf8(mime)).object<jString>());
    ...
    intent.callObjectMethod("setType", "(Ljava/lang/String;)Landroid/content/Intent;", QAndroidJniObject::fromString(String::fromUtf8(mime)).object<jString>());
  if (flag)
